...
function Dashboard() {
  ...
  const datas = ["23/04 - Avaliação P1", "04/05 - Trannferência de curso", "07/06 - Renovação de matrícula"];
  const disciplinas = ["Contrução de Frontend", "Devops", "BI e Data Warehousing"];
